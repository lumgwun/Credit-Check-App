...
public class SignUpAct extends AppCompatActivity {
    ...
    private void login(final String userName, final String password, String name, String email, String phoneNo, int profileID){
        if(!(userName.isEmpty())&& (password.isEmpty())){
            ...
            this.profileID = ThreadLocalRandom.current().nextInt(1125, 10400);
            ...
            PreferenceManager.getDefaultSharedPreferences(this).edit().putString("ProfileUserName",userName).apply();
            PreferenceManager.getDefaultSharedPreferences(this).edit().putString("ProfilePassword",password).apply();
            if(dbHelper !=null){
